                ...
                <div className="container__col character">
                    ...
                    <div className="col-75 type">
                        ...
                        {[
                            ...
                            { key: "Species:", value: data[index].species },
                            { key: "Gender:", value: data[index].gender },
                            { key: "Type:", value: data[index].type === "" ? "Undefined" : data[index].type }
                        ].map(({ key, value }, index) => (
